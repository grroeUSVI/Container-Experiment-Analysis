...
Kayla Reccomends Running an Exponential growth model for each treatment and comparing the rate constants between them
...
#import data 
ContMon <- read_excel("Kaitlin Container Experiment Analysis/data/Container Experiment Outplant Extension (CLEANED).xlsx", 
    col_types = c("numeric", "numeric", "numeric", 
        "date", "text", "text", "text", "numeric", 
        "numeric", "numeric", "numeric", 
        "numeric", "text", "text", "text", 
        "text", "numeric", "numeric", "numeric", 
        "text", "text"))#Kaitlin Note: this will not run unless you change the file path to where the data lives in your drive
...
Setup <- read_csv("Kaitlin Container Experiment Analysis/data/ContainerSetupData.csv")#change this file path to where you put the data
...
NurseryData <- read_csv("Kaitlin Container Experiment Analysis/data/NurseryMonitoring.csv")
